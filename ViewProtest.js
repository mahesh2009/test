...
class ViewProtest extends Component {
    ...
    componentDidMount() {
        ...
        if (protestID !== "") {
            fetch(`https://quiet-sea-35786.herokuapp.com/get_protests?protestID=${protestID}`)
    ...
    componentDidUpdate() {
        if (this.state.protestID !== "") {
            fetch(`https://quiet-sea-35786.herokuapp.com/get_protests?protestID=${this.state.protestID}`)
                .then(response => response.json())
    ...
    signUp() {
        ...
        fetch(`https://quiet-sea-35786.herokuapp.com/join_protest`, {
            method: "POST",
            headers: {
